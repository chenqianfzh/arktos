...
func (c *ArktosedgeV1Client) Workloads() WorkloadInterface {
	return newWorkloadsWithMultiTenancy(c, "system")
}

func (c *ArktosedgeV1Client) WorkloadsWithMultiTenancy(tenant string) WorkloadInterface {
	return newWorkloadsWithMultiTenancy(c, tenant)
}
